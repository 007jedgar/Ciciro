...
| Push | **expo-notifications** | Daily writing reminder (local schedule) plus later remote push for habit nudges and long-running / auto-draft run completion. |
...
1. **Writing reminders** (product; planned daily reminder plus other cadences).
   ...
   catalog live with writing-goal prefs (cadence, quiet hours, timezone).
