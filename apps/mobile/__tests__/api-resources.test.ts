...
const RESOURCES: ResourceCase[] = [
  ...
  {
    name: "projects.shares.list",
    run: () => ciciro.projects.shares.list("p1"),
    path: /\/api\/projects\/p1\/shares$/,
  },
  {
    name: "projects.shares.create",
    run: () => ciciro.projects.shares.create("p1", { label: "Sam", chapterIds: ["c1"], expiresInDays: 30 }),
    method: "POST",
    path: /\/api\/projects\/p1\/shares$/,
    body: { label: "Sam", chapterIds: ["c1"], expiresInDays: 30 },
  },
  {
    name: "projects.shareComments.list",
    run: () => ciciro.projects.shareComments.list("p1", "open"),
    path: /\/api\/projects\/p1\/share-comments\?status=open$/,
  },
  {
    name: "projects.shareComments.list all",
    run: () => ciciro.projects.shareComments.list("p1"),
    path: /\/api\/projects\/p1\/share-comments$/,
  },
  {
    name: "shares.revoke",
    run: () => ciciro.shares.revoke("l1"),
    method: "PATCH",
    path: /\/api\/shares\/l1$/,
    body: { revoke: true },
  },
  {
    name: "shares.delete",
    run: () => ciciro.shares.delete("l1"),
    method: "DELETE",
    path: /\/api\/shares\/l1$/,
  },
  {
    name: "shareComments.setStatus",
    run: () => ciciro.shareComments.setStatus("m1", "resolved"),
    method: "PATCH",
    path: /\/api\/share-comments\/m1$/,
    body: { status: "resolved" },
  },
  {
    name: "shareComments.delete",
    run: () => ciciro.shareComments.delete("m1"),
    method: "DELETE",
    path: /\/api\/share-comments\/m1$/,
  },
  {
