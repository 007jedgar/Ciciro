...
const es: Translations = {
  ...
  weekly: {
    ...
    cardMeta: "Cómo fue tu semana, cabos sueltos y qué escribir después",
    cardDue: "Un nuevo repaso está listo para escribirse",
    backToManuscript: "Volver al manuscrito",
    blurb: "Ciciro repasa tu semana: lo que escribiste, lo que sigue abierto en la historia y qué escribir después. Los repasos anteriores se guardan aquí.",
    reviewNow: "Repasar esta semana",
    writeNew: "Escribir un nuevo repaso",
    working: "Repasando tu semana...",
    empty: "Aún no hay repasos. Escribe uno cuando la semana te parezca terminada.",
    statsLine_one: "{{words}} palabras en {{count}} día",
    statsLine_other: "{{words}} palabras en {{count}} días",
    accountWide: "En toda tu escritura de esta semana",
    chartLabel: "Palabras escritas cada día, en toda tu escritura",
    touched: "Capítulos tocados",
    touchedNone: "Ninguno esta semana.",
    looseEnds: "Cabos sueltos",
    looseEndsNone: "Nada pendiente. Todo bien atado.",
    next: "Qué escribir después",
    past: "Repasos anteriores",
    open: "Abrir el repaso de {{range}}",
    words_one: "{{count}} palabra",
    words_other: "{{count}} palabras",
    deleteTitle: "¿Eliminar este repaso?",
    deleteMessage: "Se quitará de todos tus dispositivos.",
    deleteHint: "Mantén pulsado para eliminar",
    deleteError: "No se pudo eliminar este repaso.",
    createError: "No se pudo escribir el repaso.",
    loadError: "No se pudieron cargar tus repasos.",
  },
  beta: {
    title: "Lectores beta",
  ...
  kinds: {
    ...
    novel: { label: "Novela", description: "Capítulos, una biblia de la historia y un borrador largo." },
    screenplay: { label: "Guion", description: "Encabezados de escena, acción, diálogo y transiciones." },
    blog: { label: "Entrada de blog o boletín", description: "Una sola pieza con título y subtítulo." },
    journal: { label: "Diario", description: "Entradas con fecha, y la de hoy a un toque." },
    subtitleLabel: "Subtítulo",
    subtitlePlaceholder: "Subtítulo (opcional)",
    journalTitlePlaceholder: "Nombre del diario (opcional)",
    blogGenrePlaceholder: "Tema o nombre del boletín (opcional)",
    sequenceNumber: "Secuencia {{number}}",
    entryNumber: "Entrada {{number}}",
    post: "Entrada",
    todayEntry: "Nueva entrada de hoy",
    todayEntryMeta: "Abre la entrada de hoy o la empieza.",
    create: "Crear {{kind}}",
