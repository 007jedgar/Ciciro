const en = {
  ...
  weekly: {
    title: "Weekly review",
    cardMeta: "How your week went, loose ends, and what to write next",
    cardDue: "A new review is ready to write",
    backToManuscript: "Back to manuscript",
    blurb: "Ciciro looks back over your week: what you wrote, what is still open in the story, and what to write next. Past reviews are kept here.",
    reviewNow: "Review this week",
    writeNew: "Write a new review",
    working: "Reviewing your week...",
    empty: "No reviews yet. Write one when the week feels done.",
    statsLine_one: "{{words}} words on {{count}} day",
    statsLine_other: "{{words}} words on {{count}} days",
    accountWide: "Across all your writing this week",
    chartLabel: "Words written each day, across all your writing",
    touched: "Chapters touched",
    touchedNone: "None this week.",
    looseEnds: "Loose ends",
    looseEndsNone: "Nothing dangling. Nicely tied up.",
    next: "What to write next",
    past: "Past reviews",
    open: "Open the review for {{range}}",
    words_one: "{{count}} word",
    words_other: "{{count}} words",
    deleteTitle: "Delete this review?",
    deleteMessage: "It will be removed from all your devices.",
    deleteHint: "Long press to delete",
    deleteError: "Couldn't delete this review.",
    createError: "Couldn't write the review.",
    loadError: "Couldn't load your reviews.",
  },
  beta: {
    title: "Beta readers",
    cardMeta: "Share read-only links and read what readers said",
    cardOpen_one: "{{count}} open reader comment",
    cardOpen_other: "{{count}} open reader comments",
    backToManuscript: "Back to manuscript",
    blurb: "What beta readers said about passages you shared with them.",
    open: "Open",
    resolved: "Resolved",
    thisChapter: "This chapter only",
    emptyOpen: "No open comments. Share a link and what readers say will show up here.",
    emptyResolved: "Nothing resolved yet.",
    loadError: "Couldn't load reader comments.",
    actionError: "Couldn't update the comment.",
    byline: "{{name}} · {{date}}",
    bylineLink: "{{name}} · {{link}} · {{date}}",
    showInText: "Show in text",
    showParagraph: "Show paragraph",
    passageGone: "Passage no longer in the chapter",
    resolve: "Resolve",
    reopen: "Reopen",
    deleteTitle: "Delete this comment?",
    deleteMessage: "It can't be brought back.",
    archivedChapter: "Archived chapter",
    chapterComments_one: "{{count}} reader comment",
    chapterComments_other: "{{count}} reader comments",
    pillHint: "Opens what beta readers said about this chapter",
    links: {
      title: "Share links",
      cardMeta: "Make, share and turn off read-only links",
      back: "Back to beta readers",
      blurb: "A link opens a read-only copy of what you share, in any browser. Readers add their name and comment on passages. They see nothing else of yours, and you can turn a link off at any time.",
      labelLabel: "Who is it for?",
      labelPlaceholder: "e.g. Writing group",
      what: "What to share",
      whole: "Whole manuscript",
      chosen: "Chosen chapters",
      expires: "Link stops working",
      days_one: "In {{count}} day",
      days_other: "In {{count}} days",
      never: "Never",
      create: "Make link and share",
      creating: "Making link…",
      pickChapters: "Pick at least one chapter to share.",
      createError: "Couldn't make the link.",
      loadError: "Couldn't load your links.",
      actionError: "Couldn't update the link.",
      empty: "No links yet.",
      untitled: "Untitled link",
      active: "Active",
      expired: "Expired",
      revoked: "Turned off",
      scopeWhole: "Whole manuscript",
      scopeChapters_one: "{{count}} chapter",
      scopeChapters_other: "{{count}} chapters",
      expiresOn: "Expires {{date}}",
      expiredOn: "Expired {{date}}",
      revokedOn: "Turned off {{date}}",
      ...
      deleteMessage_zero: "This can't be undone.",
      deleteMessage_one: "Its {{count}} comment is deleted too. This can't be undone.",
      deleteMessage_other: "Its {{count}} comments are deleted too. This can't be undone.",
      shareMessage: "Would you read {{title}} and tell me what you think? Select any passage to leave a comment: {{url}}",
    },
  },
  sprint: {
  ...
  readAloud: {
    title: "Read aloud",
    cardMeta: "Hear your chapter or selection read back, handy for line edits",
    open: "Listen",
    chapterReady: "Reads the whole chapter. Select text in the editor first to read just that.",
    selectionReady: "Reads your selected text.",
    progress: "{{scope}}: sentence {{current}} of {{total}}",
    selection: "Selection",
    chapter: "Chapter",
    play: "Play",
    pause: "Pause",
  ...
  kinds: {
    ...
    novel: { label: "Novel", description: "Chapters, a story bible and a long draft." },
    screenplay: { label: "Screenplay", description: "Scene headings, action, dialogue and transitions." },
    blog: { label: "Blog post or newsletter", description: "One piece with a title and a subtitle." },
    journal: { label: "Journal", description: "Dated entries, with a new entry for today one tap away." },
    subtitleLabel: "Subtitle",
    subtitlePlaceholder: "Subtitle (optional)",
    journalTitlePlaceholder: "Journal name (optional)",
    blogGenrePlaceholder: "Topic or newsletter name (optional)",
    sequenceNumber: "Sequence {{number}}",
    entryNumber: "Entry {{number}}",
    post: "Post",
    todayEntry: "New entry for today",
    todayEntryMeta: "Opens today's entry, or starts it.",
    create: "Create {{kind}}",
